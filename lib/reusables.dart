...
//child: boxDesign(Icons.person_add, "100\n\nTotal Patient"),
Widget boxDesign(IconData icon, String title) {
  return Card(
    elevation: 10,
    child: Padding(
...
/*Widget customrow(IconData icon, String title, String count, var size) {   This function for row without shadow
  return Expanded(
    child: Container(
      margin: EdgeInsets.only(
        top: 20,
        ...
        child: Row(
          children: [
            Container(
              ...
              height: 50,
              decoration: BoxDecoration(
                //color: Colors.blue, // Change to arrowbgColor if needed
